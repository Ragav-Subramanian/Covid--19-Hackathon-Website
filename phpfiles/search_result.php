...
<?php include('../phpfiles/uptomenu.php'); ?>
...
<!-- result -->
					...
					if($count>=1){
						...
						while($row=mysqli_fetch_array($result)){
								...
								echo "<td>".$row['fee']."</td>";
						?>
							<td><a href="../phpfiles/booking.php?doc_id=<?php echo $row['doc_id'] ?>">Book</a></td>;
						<?php 		
	...
	<a href="../phpfiles/search_doctor.php">Search Again</a></button>
